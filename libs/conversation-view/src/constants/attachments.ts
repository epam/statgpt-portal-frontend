import { CrossDatasetGridAttachment, CustomChartAttachmentType, CustomGridAttachment } from '../models/attachments';
...
export const createInitialGridAttachment = (title?: string): CustomGridAttachment => {
  return {
...
export const createInitialChartAttachment = (title?: string): CustomChartAttachmentType => {
  return {
...
export const createInitialCrossDatasetGridAttachment = (title?: string): CrossDatasetGridAttachment => {
  return {
